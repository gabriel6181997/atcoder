...
#問題文
# 数直線上に 2000001 個の石が置かれています。これらの石の座標は −1000000,−999999,−999998,…,999999,1000000です。
# これらの石のうち、ある連続する KKK 個の石が黒で塗られており、それ以外の石は白で塗られています。
# また、座標 XXX にある石は黒で塗られていることが分かっています。
